...
const legalRoutes: SeoRoute[] = [
  {
    ...
    legalHighlights: [
      ...
      { label: "결제 기준", text: "유료 상담은 코드 데스티니 결제창에서 카드·카카오페이 등 단건 결제로만 받으며, 달빛 이용권·월정석은 적용되지 않습니다." },
    ...
    sections: [
      ...
      },
      {
        title: "유료 이용",
        body:
          "유료 상담은 코드 데스티니 결제창에서 카드·카카오페이 등 단건 결제로만 구매하며, 가격과 조건은 결제 전 화면에 표시됩니다. 코드 데스티니의 달빛 이용권·월정석은 적용되지 않습니다. 자동 제공·무제한·평생 이용 같은 혜택은 별도 고지가 없는 한 적용되지 않으며, 결제·환불은 코드 데스티니 이용약관과 환불 정책을 따릅니다.",
      },
      {
        title: "이용자 책임",
        body:
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "아니요. 로그인은 같은 Code Destiny 계정을 쓰지만, 영냥이 상담은 코드 데스티니 결제창의 단건 결제로만 구매하며 달빛 이용권·월정석은 적용되지 않습니다.",
      },
    ],
  },
  {
    ...
    title: "개인정보처리방침 · 영냥이",
    description:
      "영냥이가 어떤 정보를 언제 처리하는지, Code Destiny 계정·결제와의 관계와 권리 요청 방법을 쉽게 안내합니다.",
    ...
    legalHighlights: [
      ...
      { label: "계정과 결제", text: "로그인과 결제는 Code Destiny 계정과 결제창에서 처리하고, 상담 기록은 영냥이 보관함에 저장합니다." },
    ...
    sections: [
      ...
      },
      {
        title: "결제와 위탁",
        body:
          "결제는 코드 데스티니 결제창에서 결제대행사를 통해 처리되며, 결제·환불·영수증 정보는 코드 데스티니 개인정보처리방침을 따릅니다. 영냥이는 상담 권한 확인에 필요한 결제 확인 정보(결제 식별자·금액)만 전달받아 보관하고, 카드번호 같은 결제 원문은 받지 않습니다.",
      },
      {
        title: "이용자 권리",
        body:
  ...
  },
  {
    ...
    title: "환불·취소 안내 · 영냥이",
    description:
      "코드 데스티니 결제창에서 단건 결제한 영냥이 상담의 환불·취소 기준과 결과 미제공, 중복 결제 문의 방법을 안내합니다.",
    ...
    sections: [
      {
        title: "기본 기준",
        body:
          "영냥이 유료 상담은 코드 데스티니 결제창에서 카드·카카오페이 등 단건 결제로 구매하며, 환불·취소는 코드 데스티니 환불 정책을 따릅니다. 영냥이 상담에는 달빛 이용권·월정석은 적용되지 않습니다.",
      },
      {
        title: "청약철회와 제한",
        body:
  ...
  ...legalRoutes,
  {
    ...
    sections: [
      ...
      },
      {
        title: "정책은 그대로 유지",
        body:
          "이 연결은 브랜드와 로그인 흐름을 정리하는 작업입니다. 영냥이 상담은 코드 데스티니 결제창의 단건 결제로만 구매하며, 꿀꿀 운세에서 쓰는 달빛 이용권·월정석은 적용되지 않습니다.",
      },
    ],
    faq: [
      {
        ...
        answer:
          "네. 로그인은 Code Destiny의 기존 소셜 로그인 세션을 확인하는 구조를 사용합니다. 다만 영냥이 상담은 단건 결제로만 구매합니다.",
      },
      {
        question: "꿀꿀 운세의 결제 권리가 적용되나요?",
        answer:
          "아니요. 영냥이의 세계는 다른 차원이라 달빛 이용권·월정석은 적용되지 않습니다. 영냥이 상담은 코드 데스티니 결제창의 단건 결제(카드·카카오페이 등)로만 구매합니다.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        question: "꿀꿀 운세의 결제 권리가 자동 적용되나요?",
        answer:
          "아니요. 영냥이 상담은 코드 데스티니 결제창에서 단건 결제(카드·카카오페이 등)로만 구매하며, 달빛 이용권·월정석은 적용되지 않습니다.",
      },
    ],
  },
  {
    ...
    faq: [
      {
        ...
        answer:
          "유료 상담은 서버에서 계산한 차트를 근거로 AI가 문장을 정리해 한 권의 책으로 엮습니다. 제공 준비가 끝난 상담만 구매할 수 있고, 준비 중인 상담은 화면에 '준비 중'으로 표시됩니다.",
      },
      {
