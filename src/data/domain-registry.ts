...
export const domainRegistry = {
  saju: {
    ...
    freeEntry: { href: "/free-fortune/?category=saju", label: "무료 사주 흐름 보기" },
    paidEntry: {
      href: "/fortune/?domain=saju&fish=mackerel",
      label: "단건 사주 상담 시작하기",
  ...
  sukuyo: {
    ...
    freeEntry: { href: "/free-fortune/?category=sukuyo", label: "무료 숙요 흐름 보기" },
    paidEntry: {
      href: "/fortune/?domain=sukuyo&fish=mackerel",
      label: "단건 숙요 상담 시작하기",
  ...
  ziwei: {
    ...
    freeEntry: { href: "/free-fortune/?category=ziwei", label: "무료 자미두수 흐름 보기" },
    paidEntry: {
      href: "/fortune/?domain=ziwei&fish=mackerel",
  ...
  vedic: {
    ...
    freeEntry: { href: "/free-fortune/?category=vedic", label: "무료 베다점 흐름 보기" },
    paidEntry: {
      href: "/fortune/?domain=vedic&fish=mackerel",
  ...
  astrology: {
    ...
    freeEntry: {
      href: "/free-fortune/?category=astrology",
      label: "무료 점성술 흐름 보기",
    },
    paidEntry: {
      href: "/fortune/?domain=astrology&fish=mackerel",
  ...
  tarot: {
    ...
    freeEntry: { href: "/free-fortune/?category=tarot", label: "무료 타로 흐름 보기" },
    paidEntry: {
      href: "/fortune/?domain=tarot&fish=mackerel",
      label: "단건 타로 상담 시작하기",
