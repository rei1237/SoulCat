...
const child=spawn(process.execPath,['node_modules/wrangler/bin/wrangler.js','pages','dev','out','--ip','127.0.0.1','--port',process.argv[2]||'8791','--binding','APP_ENV=local','--binding','LLM_PROVIDER=mock','--binding','ALLOW_LIVE_LLM=false'],{env,stdio:'inherit'});
